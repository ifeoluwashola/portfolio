      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
          <div className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
            {/* Runaway Cloud Bills */}
            <Card className="bg-card/40 backdrop-blur-sm border-sky-500/20 hover:border-sky-500/50 transition-all duration-300 relative overflow-hidden group">
              ...
              <CardContent className="relative z-10">
                <p className="text-muted-foreground leading-relaxed">
                  Paying for unoptimized, orphaned resources.
                </p>
              </CardContent>
            </Card>

            {/* Deployment Bottlenecks */}
            <Card className="bg-card/40 backdrop-blur-sm border-emerald-500/20 hover:border-emerald-500/50 transition-all duration-300 relative overflow-hidden group">
              ...
              <CardContent className="relative z-10">
                <p className="text-muted-foreground leading-relaxed">
                  Manual processes slowing down feature releases.
                </p>
              </CardContent>
            </Card>

            {/* Security Vulnerabilities */}
            <Card className="bg-card/40 backdrop-blur-sm border-rose-500/20 hover:border-rose-500/50 transition-all duration-300 relative overflow-hidden group">
              ...
              <CardContent className="relative z-10">
                <p className="text-muted-foreground leading-relaxed">
                  Permissive IAM roles and unpatched containers.
                </p>
              </CardContent>
            </Card>
          </div>
