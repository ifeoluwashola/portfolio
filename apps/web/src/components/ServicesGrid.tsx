    ...
    <section id="services" className="py-24 sm:py-32 bg-background border-t border-border">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center mb-16 sm:mb-20">
          <h2 className="text-base font-semibold leading-7 text-sky-400 tracking-widest uppercase">Deep-Dive Services</h2>
            ...
            return (
              <div key={service.title} className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
                <div className={`w-full lg:w-1/2 ${isEven ? "lg:order-1" : "lg:order-2"}`}>
                  ...
                  <h3 className="text-3xl font-bold tracking-tight text-foreground mb-4">{service.title}</h3>
                  <p className="text-lg text-muted-foreground mb-8 text-balance">
                    {service.description}
                  </p>
                  
                  <div className="space-y-4">
                    <h4 className="font-semibold text-foreground uppercase tracking-widest text-sm mb-4">Key Deliverables</h4>
                ...
                <div className={`w-full lg:w-1/2 ${isEven ? "lg:order-2" : "lg:order-1"}`}>
                  <Card className={`bg-card/40 backdrop-blur-sm border ${service.borderColor} ${service.hoverBorder} transition-all duration-500 h-[300px] sm:h-[400px] flex items-center justify-center relative overflow-hidden group`}>
