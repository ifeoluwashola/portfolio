  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center space-y-8 animate-in fade-in zoom-in duration-500">
        ...
        <div className="bg-card border border-border p-6 rounded-xl text-left space-y-4">
        ...
        <div className="pt-8 opacity-20 select-none">
          <div className="text-[10px] font-mono text-muted-foreground overflow-hidden whitespace-nowrap">
