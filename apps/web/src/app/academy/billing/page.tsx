...
const STATUS = {
  ...
  payment_locked: {
    ...
    cls: "bg-red-500/10 border-red-500/25 text-red-600 dark:text-red-400",
  },
  paid_in_full: {
    label: "Paid in Full",
    icon: <CheckCircle2 className="w-4 h-4 text-yellow-600 dark:text-yellow-400" />,
    cls: "bg-yellow-500/10 border-yellow-500/20 text-yellow-600 dark:text-yellow-400",
  },
} as const;
...
export default function BillingHubPage() {
    ...
    return (
      <div className="flex items-center justify-center min-h-[50vh] bg-background">
        <div className="text-center space-y-3">
          ...
          <Link href="/academy/dashboard" className="text-yellow-600 dark:text-yellow-500 text-xs hover:underline">← Back to Dashboard</Link>
        </div>
      </div>
    );
  }
  ...
  if (!hub) {
    return (
      <div className="space-y-8 animate-pulse p-8 bg-background min-h-screen">
        ...
        {billing.billing_status === "payment_locked" && (
          <div className="flex items-start gap-4 bg-red-500/8 border border-red-500/30 rounded-2xl p-5 shadow-[0_0_30px_rgba(239,68,68,0.08)]">
            ...
            <div className="flex-1">
              <h3 className="font-bold text-red-700 dark:text-red-300 mb-1">Portal Access Suspended</h3>
        ...
        <div className="bg-card border border-border rounded-3xl p-8 relative overflow-hidden">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-8 relative z-10">
            ...
            {billing.next_payment_due_date && billing.billing_status !== "paid_in_full" && (
              <div className="flex items-center gap-2 text-xs text-muted-foreground">
                ...
                Next due: <span className="font-semibold text-amber-600 dark:text-amber-400">{fmtDate(billing.next_payment_due_date)}</span>
              </div>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8 relative z-10">
            {[
              ...
              { label: "Total Due", value: fmt(TOTAL_DUE_KOBO), color: "text-muted-foreground" },
          ...
          <div className="relative z-10">
            <div className="flex justify-between text-[10px] font-bold uppercase tracking-wider text-muted-foreground/60 mb-2">
              ...
              <span className={billing.billing_status === "paid_in_full" ? "text-yellow-600 dark:text-yellow-500" : "text-muted-foreground"}>
          ...
          <div className="bg-card/50 border border-border rounded-3xl p-8">
            ...
            <div className="space-y-5">
              <div>
                ...
                {amountError && (
                  <div className="mt-2 flex items-start gap-2 text-xs text-red-500 bg-red-500/10 border border-red-500/20 rounded-lg px-3 py-2.5">
                ...
                {isFinalPayment && (
                  <p className="mt-2 text-[10px] text-muted-foreground/50 leading-relaxed uppercase font-black tracking-widest">
              ...
              <p className="text-[10px] text-muted-foreground/50 text-center uppercase font-bold tracking-widest">
                    ...
                    >
                      ...
                      <td className="px-5 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          >
                            <ExternalLink className="w-3.5 h-3.5 text-muted-foreground/40 hover:text-yellow-600 dark:hover:text-yellow-500 transition-colors" />
                          </a>
                        </div>
                      </td>
                      <td className="px-5 py-4">
                        <span className="inline-flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 px-2.5 py-1 rounded-full">
