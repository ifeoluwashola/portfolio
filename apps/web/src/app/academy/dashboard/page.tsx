    ...
    <div className="space-y-8">
      ...
      {isLocked && (
        <div className="flex items-start gap-4 bg-red-500/8 border border-red-500/30 rounded-2xl p-5 shadow-[0_0_30px_rgba(239,68,68,0.08)]">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[10px] font-bold uppercase tracking-widest text-red-400/70 mb-1">Action Required</p>
            <h3 className="text-base font-bold text-red-300 mb-1">Access Suspended — Overdue Balance</h3>
      ...
      {!isLocked && hasBalance && billing?.billing_status === "good_standing" && (
        <div className="flex items-center gap-4 bg-amber-500/5 border border-amber-500/20 rounded-2xl p-4">
          ...
          <Link
            href="/academy/dashboard/billing"
            className="flex-shrink-0 flex items-center gap-2 px-4 py-2 bg-amber-500/10 border border-amber-500/30 text-amber-300 hover:bg-amber-500/20 text-xs font-bold uppercase tracking-widest rounded-xl transition-all"
          >
            Make Payment
