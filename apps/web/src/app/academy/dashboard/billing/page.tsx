...
const STATUS = {
  good_standing: {
    ...
    cls: "bg-emerald-500/10 border-emerald-500/20 text-emerald-400 dark:text-emerald-400",
  },
  payment_locked: {
    ...
    <div className="space-y-8 max-w-3xl">
      ...
      {billing.billing_status === "payment_locked" && (
        <div className="flex items-start gap-4 bg-red-500/8 border border-red-500/30 rounded-2xl p-5 shadow-[0_0_30px_rgba(239,68,68,0.08)]">
          ...
          <div className="flex-1">
            <h3 className="font-bold text-red-600 dark:text-red-300 mb-1">Portal Access Suspended</h3>
      ...
      {canPay && (
        <div className="bg-card/50 border border-border rounded-3xl p-8">
          ...
          <div className="space-y-5">
            <div>
              <label className="block text-xs font-bold uppercase tracking-widest text-muted-foreground/60 mb-2">
            ...
            <p className="text-[10px] text-muted-foreground/60 text-center uppercase font-bold tracking-widest">
      ...
      <div className="bg-card/50 border border-border rounded-3xl p-8">
        ...
        {payment_history.length === 0 ? (
          <div className="text-center py-12 border border-dashed border-border rounded-2xl text-muted-foreground/40">
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-border/60">
                {payment_history.map((tx: PaymentHistoryItem, idx: number) => (
                  ...
                  >
                    <td className="px-5 py-4 text-muted-foreground/40 font-mono text-xs">{payment_history.length - idx}</td>
                    <td className="px-5 py-4 text-muted-foreground/60 text-xs whitespace-nowrap">{fmtDate(tx.created_at)}</td>
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        >
                          <ExternalLink className="w-3.5 h-3.5 text-muted-foreground/40 hover:text-yellow-500 transition-colors" />
                        </a>
                      </div>
                    </td>
                    <td className="px-5 py-4">
