    ...
    <div className="bg-background min-h-screen py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mb-8 flex items-center space-x-2 text-sm text-muted-foreground">
          ...
          <span className="font-medium text-yellow-400">Academy Hub</span>
          <span>/</span>
        ...
        <div className="grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {materials.map((material) => (
            <article
              key={material.slug}
              className="flex max-w-xl flex-col items-start justify-between bg-card/50 backdrop-blur-sm p-6 rounded-2xl border border-border hover:border-yellow-500/50 transition-all duration-300"
            >
              <div className="flex items-center gap-x-4 text-xs">
                ...
                <span className="relative z-10 rounded-full px-3 py-1.5 font-medium bg-yellow-500/10 text-yellow-400">
                  {material.category}
                </span>
              </div>
              <div className="group relative">
                <h3 className="mt-3 text-lg font-semibold leading-6 text-foreground group-hover:text-yellow-400 transition-colors">
              ...
              <div className="mt-6 flex items-center gap-x-4 w-full border-t border-border pt-4">
                <Link
                  ...
                  className="text-sm font-semibold leading-6 text-yellow-400 flex flex-row items-center gap-2 group w-full justify-between"
                >
                  Start Learning
